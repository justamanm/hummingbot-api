...
class MicroduckProfitTrailingConfig(ControllerConfigBase):
    ...
    buy_trailing_rebound_percent: Decimal = Field(default=Decimal("2"), gt=Decimal("0"), lt=Decimal("100"), json_schema_extra={"is_updatable": True})
    buy_trailing_rebound_adjustment_factor: Decimal = Field(default=Decimal("0.2"), ge=Decimal("0"), json_schema_extra={"is_updatable": True})
